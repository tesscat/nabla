...
run: all
	NABLA_loader__search_path="['./$(OUT_DIR)/modules']" NABLA_loader__modules="['core']" $(OUT_DIR)/nabla

dbg: all 
	NABLA_loader__search_path="['./$(OUT_DIR)/modules']" NABLA_loader__modules="['core']" lldb $(OUT_DIR)/nabla
